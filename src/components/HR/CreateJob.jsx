        ...
        <div className='m-0 bg-gray-100 p-[1em] h-screen'>
            ...
            <div className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline col-span-2 ">
              {skills.map((skill, index) => (
                <span key={index}>
                  <button
                    className={`m-2 ml-2 text-red-500 bg-gray-200 hover:bg-gray-400 font-bold py-2 px-4 rounded ${
            ...
            <div className="col-span-2">
              <button
                className="bg-[#338573] hover:bg-[#338573] text-white font-bold py-2 px-4 rounded"
                onClick={() => showModal()}
              >
                Add New Posting
              </button>
